...
```{r echo=FALSE}
# Utility function to plot a univariate histogram plot for given variable of interest and its bindwidth
...
pairs.panels(wine, scale=T, smooth=T, digits=3, main="Pairwise bird eyeview plot of all attributes for White Wine dataset")
...
cor.plot(cor(wine[2:13]), numbers=T, main="Correlation Matrix Plot for White Wine")
```
