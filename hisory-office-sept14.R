...
?ggpirs
?ggpairs
ggpairs(wine, axisLabels="internals")
ggpairs(wine, axisLabels="internal")
ggsave("wine_ggairs.jpg")
ggplot(data=wine, aes(x=quality)) + geom_histogram()
ggplot(data=wine, aes(x=quality)) + geom_histogram(binwidth=0.5)
ggplot(data=wine, aes(x=quality)) + geom_histogram(binwidth=0.25)
ggplot(data=wine, aes(x=quality)) + geom_histogram(binwidth=1)
ggplot(data=wine, aes(x=quality, color="blue")) + geom_histogram(binwidth=1)
ggplot(data=wine, aes(x=quality, color="Red")) + geom_histogram(binwidth=1)
ggsave("wine_quality_histogram.jpg")
ggplot(data=wine, aes(y=quality, x=alcohol)) + geom_point()
ggplot(data=wine, aes(y=quality, x=pH)) + geom_point()
ggplot(data=wine, aes(y=quality, x=density)) + geom_point()
ggplot(data=wine, aes(y=quality, x=citric.acid)) + geom_point()
ggplot(data=wine, aes(y=quality, x=free.sulfur.dioxide)) + geom_point()
ggplot(data=wine, aes(y=quality, x=chlorides)) + geom_point()
ggplot(data=wine, aes(y=quality, x=fixed.acidity)) + geom_point()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_point()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line() + scale_ylog10()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line() + scale_y_log10()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line() + scale_x_log10()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line() + scale_x_log10() + scale_y_log10()
ggplot(data=wine, aes(y=quality, x=volatile.acidity)) + geom_line()
ggplot(data=wine, aes(y=quality, x=volatile.acidity, color=sulphates)) + geom_line()
ggplot(data=wine, aes(y=quality, x=volatile.acidity, color=sulphates)) + geom_point()
ggplot(data=wine, aes(y=quality, x=volatile.acidity, color=density)) + geom_point()
ggplot(data=wine, aes(y=quality, x=volatile.acidity, color=density)) + geom_point(binwidth=0.05)
ggplot(data=wine, aes(y=quality, x=volatile.acidity, color=density)) + geom_point(binwidth=0.01)
savehistory("~/GitHub/EDA/hisory-office-sept14.R")
