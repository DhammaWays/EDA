...
var ajaxCart = {
	...
	overrideButtonsInThePage : function(){
		...
		$('.ajax_cart_block_remove_link').unbind('click').click(function(){
			...
			ajaxCart.remove(productId, productAttributeId, customizationId, static_token);
			return false;
		});
	},
	...
	remove : function(idProduct, idCombination, customizationId, static_token){
		//send the ajax request to the server
		$.ajax({
			type: 'GET',
			url: baseDir + 'cart.php',
	...
	updateCartEverywhere : function(jsonData) {
        ...
        {
            $('p.freeship').show();
            $('.ajax_cart_shipping_cost').css('color','#c80000');
        }
        else
        {
            $('p.freeship').hide();
            $('.ajax_cart_shipping_cost').css('color','#000000');
        }
